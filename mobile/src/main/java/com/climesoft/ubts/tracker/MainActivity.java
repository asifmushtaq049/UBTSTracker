package com.climesoft.ubts.tracker;
...
public class MainActivity extends AppCompatActivity {
    ...
    private final static String BUSS_ID = "TEwSMfdBd6gwxQGobUCq";
    ...
    private void updateLocationUI() {
        if (mCurrentLocation != null) {
            ...
            try {
                ...
                data.put("lat", lat+"");
                data.put("lng", lng+"");
                data.put("time", mLastUpdateTime);
                data.put("address", address);
                data.put("city", city);
                db.collection("location").document(BUSS_ID)
                        .set(data)
